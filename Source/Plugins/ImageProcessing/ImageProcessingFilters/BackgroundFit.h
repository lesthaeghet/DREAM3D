...
#ifndef _BackgroundFit_H_
#define _BackgroundFit_H_
...
/**
 * @class BackgroundFit BackgroundFit.h ImageProcessing/ImageProcessingFilters/BackgroundFit.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class BackgroundFit : public AbstractFilter
{
  Q_OBJECT /* Need this for Qt's signals and slots mechanism to work */

  public:
    DREAM3D_SHARED_POINTERS(BackgroundFit)
    DREAM3D_STATIC_NEW_MACRO(BackgroundFit)
    DREAM3D_TYPE_MACRO_SUPER(BackgroundFit, AbstractFilter)
  ...
  private:
    ...
    BackgroundFit(const BackgroundFit&); // Copy Constructor Not Implemented
    void operator=(const BackgroundFit&); // Operator '=' Not Implemented
};

#endif /* _BackgroundFit_H_ */
