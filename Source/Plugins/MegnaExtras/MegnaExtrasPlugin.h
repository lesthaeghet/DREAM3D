...
#ifndef _MegnaExtras_H_
#define _MegnaExtras_H_
...
/**
 * @class MegnaExtrasPlugin MegnaExtrasPlugin.h SurfaceMeshing/MegnaExtrasPlugin.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class MegnaExtrasPlugin : public QObject, public DREAM3DPluginInterface
{
    Q_OBJECT
  ...
  private:
    MegnaExtrasPlugin(const MegnaExtrasPlugin&); // Copy Constructor Not Implemented
    void operator=(const MegnaExtrasPlugin&); // Operator '=' Not Implemented
};

#endif /* _MegnaExtras_H_ */
