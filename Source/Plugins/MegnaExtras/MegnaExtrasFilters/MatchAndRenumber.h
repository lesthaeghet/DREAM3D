...
#ifndef _MatchAndRenumber_H_
#define _MatchAndRenumber_H_
...
/**
 * @class MatchAndRenumber MatchAndRenumber.h MegnaExtras/MegnaExtrasFilters/MatchAndRenumber.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class MatchAndRenumber : public AbstractFilter
{
  Q_OBJECT /* Need this for Qt's signals and slots mechanism to work */

  public:
    DREAM3D_SHARED_POINTERS(MatchAndRenumber)
    DREAM3D_STATIC_NEW_MACRO(MatchAndRenumber)
    DREAM3D_TYPE_MACRO_SUPER(MatchAndRenumber, AbstractFilter)

    virtual ~MatchAndRenumber();
  ...
  private:
    ...
    MatchAndRenumber(const MatchAndRenumber&); // Copy Constructor Not Implemented
    void operator=(const MatchAndRenumber&); // Operator '=' Not Implemented
};

#endif /* _MatchAndRenumber_H_ */
