...
#include "MatchAndRenumber.h"

#include <QtCore/QString>

#include "MegnaExtras/MegnaExtrasConstants.h"

// -----------------------------------------------------------------------------
//
// -----------------------------------------------------------------------------
MatchAndRenumber::MatchAndRenumber() :
  AbstractFilter()
...
//
// -----------------------------------------------------------------------------
void MatchAndRenumber::setupFilterParameters()
{
...
//
// -----------------------------------------------------------------------------
void MatchAndRenumber::readFilterParameters(AbstractFilterParametersReader* reader, int index)
{
...
//
// -----------------------------------------------------------------------------
int MatchAndRenumber::writeFilterParameters(AbstractFilterParametersWriter* writer, int index)
{
...
//
// -----------------------------------------------------------------------------
void MatchAndRenumber::dataCheck()
{
  setErrorCondition(0);
...
//
// -----------------------------------------------------------------------------
void MatchAndRenumber::preflight()
{
...
//
// -----------------------------------------------------------------------------
const QString MatchAndRenumber::getCompiledLibraryName()
{
  return MegnaExtras::MegnaExtrasBaseName;
}

// -----------------------------------------------------------------------------
//
// -----------------------------------------------------------------------------
const QString MatchAndRenumber::getGroupName()
{
  return "MegnaExtras";
}
...
//
// -----------------------------------------------------------------------------
const QString MatchAndRenumber::getHumanLabel()
{
  return "MatchAndRenumber";
}

// -----------------------------------------------------------------------------
//
// -----------------------------------------------------------------------------
const QString MatchAndRenumber::getSubGroupName()
{
  return "Misc";
}
...
//
// -----------------------------------------------------------------------------
AbstractFilter::Pointer MatchAndRenumber::newFilterInstance(bool copyFilterParameters)
{
  /*
  * write code to optionally copy the filter parameters from the current filter into the new instance
  */
  MatchAndRenumber::Pointer filter = MatchAndRenumber::New();
