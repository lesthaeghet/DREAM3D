...
set(_filterGroupName MegnaExtrasFilters)
set(${_filterGroupName}_FILTERS_HDRS "")

#--------
# This macro must come first before we start adding any filters
START_FILTER_GROUP(${MegnaExtras_BINARY_DIR} "${_filterGroupName}" "MegnaExtras")
...
foreach(f ${_PublicFilters} )
  ADD_DREAM3D_FILTER(  "MegnaExtras" "MegnaExtras"
                        ${_filterGroupName} ${f}
                        ${MegnaExtras_SOURCE_DIR}/Documentation/${_filterGroupName}/${f}.md TRUE)
endforeach()
...
END_FILTER_GROUP(${MegnaExtras_BINARY_DIR} "${_filterGroupName}" "MegnaExtras")
