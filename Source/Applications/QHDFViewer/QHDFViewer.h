  ...
  void setupMenuBar()
    {
      ...
      actionOpen->setText(QApplication::translate("QHDFViewer", "Open ...", 0));
      actionOpen->setShortcut(QApplication::translate("QHDFViewer", "Ctrl+O", 0));

      QAction* actionClose = new QAction(this);
      actionClose->setObjectName(QString::fromUtf8("actionClose"));
      actionClose->setShortcutContext(Qt::WidgetShortcut);
      actionClose->setText(QApplication::translate("QHDFViewer", "Close", 0));
      actionClose->setShortcut(QApplication::translate("QHDFViewer", "Ctrl+W", 0));
      ...
      menu_RecentFiles->setTitle(QApplication::translate("QHDFViewer", "Recent Files...", 0));
