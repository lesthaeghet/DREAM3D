...
#-- can run.
function(AddQhullCopyInstallRules)
	set(options)
	set(oneValueArgs CMAKE_VAR PREFIX)
	set(multiValueArgs)

	cmake_parse_arguments(P "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN} )
	#message(STATUS "Copying Qhull Runtime Libraries: ${P_LIBRARIES}")
	...
	set(SUPPORT_LIB_OPTION 3)
	 ...
	 #message(STATUS "AddQhullCopyInstallRules SUPPORT_LIB_OPTION  = ${SUPPORT_LIB_OPTION}")
...
#------------------------------------------------------------------------------
# Make sure we have Qhull installed and available
find_package(Qhull)
if(QHULL_FOUND)
	#message(STATUS "QHULL_INCLUDE_DIR: ${CMP_PLUGIN_SEARCHDIR_FILE}")
    include_directories(${QHULL_INCLUDE_DIR})
    FILE(APPEND ${CMP_PLUGIN_SEARCHDIR_FILE} "${QHULL_LIB_DIR};")
    AddQhullCopyInstallRules(PREFIX "" CMAKE_VAR QHULL_LIBRARY)
else()
    message(FATAL_ERROR "Qhull is required for this project")
endif()
